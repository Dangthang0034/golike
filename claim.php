...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, "https://claim.ourcoincash.xyz/faucet/currency/doge");
...
curl_setopt($ch, CURLOPT_URL, "https://claim.ourcoincash.xyz/faucet/verify/doge");
...
while(true){
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://claim.ourcoincash.xyz/faucet/currency/trx");
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($ch, CURLOPT_COOKIE, $cookie);
    $response = curl_exec($ch);
    ...
    curl_setopt($ch, CURLOPT_URL, "https://claim.ourcoincash.xyz/faucet/verify/trx");
    curl_setopt($ch, CURLOPT_POST, true);
    curl_setopt($ch, CURLOPT_POSTFIELDS, http_build_query($postData));
    curl_setopt($ch, CURLOPT_COOKIE, $cookie);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    ...
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://claim.ourcoincash.xyz/faucet/currency/bnb");
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($ch, CURLOPT_COOKIE, $cookie);
    $response = curl_exec($ch);
    ...
    curl_setopt($ch, CURLOPT_URL, "https://claim.ourcoincash.xyz/faucet/verify/bnb");
    curl_setopt($ch, CURLOPT_POST, true);
